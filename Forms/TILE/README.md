...
- `index.html` — form structure and reusable item templates
...
The form works without a server. Open `index.html` in a browser, or serve the folder locally for a normal HTTP origin:
